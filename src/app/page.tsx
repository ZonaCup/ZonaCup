...
export default function Home() {
  ...
  async function loadTournaments() {
    const { data } = await supabase
      .from('tournaments')
      .select('id,name,slug,format,date,entry_fee_usd,entry_fee_ars,entry_fee_clp,entry_fee_pen,prize_pool,max_slots,current_slots,is_major,is_special,status')
    ...
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_520px] gap-12 lg:gap-16 max-w-7xl mx-auto w-full relative z-20">
          <div>
            ...
            <p className="text-[17px] leading-relaxed text-smoke mb-9 max-w-xl">
              ...
              Premios pagados en el Acto.<br />
              Ranking de los mejores USER temporada tras temporada.
            </p>
          ...
          <div className="w-full max-w-[520px] mx-auto lg:mx-0 lg:pt-2 self-stretch">
            <TournamentCard tournament={nextTournament} />
          </div>
        </div>
      </section>
      ...
      <section className="bg-bg-dark" id="porque">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20">
          <div className="section-tag">Por que Zona Cup</div>
          <h2 className="section-title">Deja de jugar<br />torneos improvisados.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 mt-12">
            {[
              ...
              },
              {
                ...
                desc: 'Cada torneo suma puntos. Top 50 accede a premios exclusivos e invitacion a los Majors trimestrales.',
              },
              {
                icon: <><circle cx="12" cy="12" r="9" /><path d="M12 7V12L15 15" /></>,
                title: 'Operacion en real',
                desc: 'Web propia, bracket en tiempo real, arbitros dedicados, reglas claras. Ya sea tu primer torneo o el #100.',
              },
              {
                icon: <path d="M12 2L2 7V12C2 17 6 21 12 22C18 21 22 17 22 12V7L12 2Z" />,
                title: 'Anti-cheat serio',
                desc: 'VOD review desde Top 8. Ban permanente y publico con evidencia. Este circuito protege al que juega limpio.',
              },
            ].map((p) => (
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-20" id="como">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 mt-12">
          {[
            ['01', 'Registrate', 'Un click con Discord. Completa tu Riot ID y tu rango. 60 segundos.'],
            ['02', 'Arma tu equipo', 'Invita con codigo, busca compañero en Discord, o entra al matchmaking.'],
            ['03', 'Paga tu entrada', 'Cada uno paga lo suyo. Mercado Pago, tarjeta o transferencia segun tu pais.'],
            ['04', 'A jugar.', 'Bracket en vivo, lobbies automaticos. Premios en tu cuenta en 48 horas.'],
          ].map(([num, title, desc]) => (
      ...
      <section className="bg-bg-dark" id="torneos">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20">
          ...
          <h2 className="section-title">Proximos torneos.</h2>
          ...
          {filteredTournaments.length === 0 ? (
            <div className="card p-10 text-center">
              <p className="text-ash text-lg">No hay torneos cargados para este filtro.</p>
              <Link href="/torneos" className="inline-block mt-4">
                <button className="btn-ghost">Ver calendario completo</button>
              </Link>
            </div>
          ) : (
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-display text-base text-ivory tracking-wider flex items-center gap-2 flex-wrap mb-1">
                        {t.name}
                        <span className={`text-[9px] px-2 py-0.5 rounded-sm tracking-[1.5px] font-bold uppercase ${badgeClass}`}>
          ...
          <div className="mt-6">
            <Link href="/torneos">
              <button className="btn-ghost">Ver todos los torneos</button>
            </Link>
          </div>
        </div>
      </section>
      ...
      <section className="bg-bg-dark" id="pro">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center">
          ...
          <h2 className="section-title">Si vas en serio,<br />aca hay mas.</h2>
          <p className="text-[15px] text-smoke mx-auto max-w-md">Membresias mensual. Cancelas cuando quieras.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 max-w-2xl mx-auto mt-12">
            <div className="card p-7 text-left">
              ...
              <div className="flex flex-col gap-2.5 mt-5 text-[13px] text-smoke">
                {['Acceso a todos los torneos Open', 'Ranking oficial de temporada', 'Comunidad en Discord', 'Stats b&aacute;sicas de tu perfil'].map((f) => (
      ...
      <section className="bg-bg-dark" id="comunidad">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center">
          ...
          <p className="text-[15px] text-smoke max-w-md mx-auto leading-relaxed mb-6">
            Buscas duo, ves el bracket en vivo, recibis los codigos de lobby y te enteras primero. Todo pasa ahi.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center" id="faq">
        ...
        <h2 className="section-title">Lo que te estas<br />preguntando.</h2>
        <FAQ />
      </section>
      ...
      <section className="relative py-24 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto px-5">
          <div className="section-tag">Proximo torneo · 25 ABR</div>
