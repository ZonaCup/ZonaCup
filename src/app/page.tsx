...
export default function Home() {
  return (
    <>
      ...
      {/* ===== HERO ===== */}
      <section className="relative min-h-screen flex items-center px-5 md:px-10 pt-24 pb-16 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_30%_50%,rgba(255,106,0,0.06)_0%,transparent_60%),radial-gradient(ellipse_at_70%_30%,rgba(194,58,10,0.04)_0%,transparent_50%)]" />
        <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-bg-deep to-transparent z-10" />

        <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 lg:gap-16 max-w-7xl mx-auto w-full relative z-20">
          <div>
            <div className="inline-flex items-center gap-2 bg-fire-core/10 border border-fire-core/30 px-3.5 py-1.5 rounded-sm mb-7">
            ...
            <h1 className="font-display text-4xl md:text-[52px] leading-[1.1] font-extrabold text-ivory tracking-wide uppercase mb-5">
              El circuito<br />competitivo<br />de <span className="fire-text">VALORANT</span><br />en LATAM
            </h1>

            <p className="text-[17px] leading-relaxed text-smoke mb-9 max-w-xl">
              Torneos 2v2 y 5v5 todas las semanas. Premios pagados en 48 horas. Ranking que te acompaña temporada tras temporada. Sin improvisar.
            </p>

            <div className="flex flex-wrap gap-3 mb-12">
              <Link href="/torneos"><button className="btn-fire">Inscribirme al próximo torneo</button></Link>
              <a href="#como"><button className="btn-ghost">Cómo funciona</button></a>
            </div>
      ...
      <section className="bg-bg-dark" id="porque">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20">
          <div className="section-tag">Por qué Zona Cup</div>
          <h2 className="section-title">Dejá de jugar<br />torneos improvisados.</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 mt-12">
            {[
              ...
              },
              {
                ...
                desc: 'Cada torneo suma puntos. Top 50 accede a premios exclusivos e invitación a los Majors trimestrales.',
              },
              {
                icon: <><circle cx="12" cy="12" r="9" /><path d="M12 7V12L15 15" /></>,
                title: 'Operación real',
                desc: 'Web propia, bracket en tiempo real, árbitros dedicados, reglas claras. Ya sea tu primer torneo o el #100.',
              },
              {
                icon: <path d="M12 2L2 7V12C2 17 6 21 12 22C18 21 22 17 22 12V7L12 2Z" />,
                title: 'Anti-cheat serio',
                desc: 'VOD review desde Top 8. Ban permanente y público con evidencia. Este circuito protege al que juega limpio.',
              },
            ].map((p) => (
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-20" id="como">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 mt-12">
          {[
            ['01', 'Registrate', 'Un click con Discord. Completá tu Riot ID y tu rango. 60 segundos.'],
            ['02', 'Armá tu equipo', 'Invitá con código, buscá compañero en Discord, o entrá al matchmaking.'],
            ['03', 'Pagá tu entrada', 'Cada uno paga lo suyo. Mercado Pago, tarjeta o transferencia según tu país.'],
            ['04', 'A jugar.', 'Bracket en vivo, lobbies automáticos. Premios en tu cuenta en 48 horas.'],
          ].map(([num, title, desc]) => (
      ...
      <section className="bg-bg-dark" id="torneos">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20">
          ...
          <div className="flex flex-col gap-2.5">
            {[
              { month: 'ABR', day: '25', name: 'Zona Cup Weekly #12', badge: '2V2 · Open', badgeClass: 'bg-fire-core/12 text-fire-core', detail: 'Sábado · 20:00 ART · 23/32 duplas · Single elim', pool: 'USD 512', entry: 'USD 8', cta: 'Inscribirme', major: false },
              { month: 'MAY', day: '02', name: 'Zona Cup Weekly #13', badge: '2V2 · Open', badgeClass: 'bg-fire-core/12 text-fire-core', detail: 'Sábado · 20:00 ART · 5/32 duplas · Single elim', pool: 'USD 512', entry: 'USD 8', cta: 'Inscribirme', major: false },
              { month: 'MAY', day: '10', name: 'Clash 5v5 · Main Event', badge: '5V5 · Major', badgeClass: 'bg-fire-core text-white', detail: 'Sábado · 18:00 ART · 16 equipos · BO3 playoffs · Streamed', pool: 'USD 960', entry: 'USD 12', cta: 'Pre-registro', major: true },
              { month: 'MAY', day: '16', name: 'Underdog Night', badge: '2V2 · Raro', badgeClass: 'bg-green-400/12 text-green-400', detail: 'Viernes · 21:00 ART · Solo duelistas · Rango máx: Platino', pool: 'USD 280', entry: 'USD 5', cta: 'Pre-registro', major: false },
            ].map((t) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mt-12">
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <div className="card p-4"><div className="font-display text-2xl font-bold text-ivory">32</div><div className="text-[10px] text-ash tracking-[1.5px] uppercase mt-0.5">Días restantes</div></div>
            ...
            <Link href="/ranking"><button className="btn-ghost">Ver ranking completo →</button></Link>
          </div>
      ...
      <section className="bg-bg-dark" id="pro">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center">
          ...
          <h2 className="section-title">Si vas en serio,<br />acá hay más.</h2>
          <p className="text-[15px] text-smoke mx-auto max-w-md">Membresía mensual. Cancelás cuando quieras.</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 max-w-2xl mx-auto mt-12">
            <div className="card p-7 text-left">
              ...
              <div className="flex flex-col gap-2.5 mt-5 text-[13px] text-smoke">
                {['Acceso a todos los torneos Open', 'Ranking oficial de temporada', 'Comunidad en Discord', 'Stats básicas de tu perfil'].map(f => (
                  <div key={f} className="flex gap-2"><span className="text-green-400 font-bold shrink-0">✓</span> {f}</div>
                ))}
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center" id="premios">
        ...
        <p className="text-[15px] text-smoke mx-auto max-w-md mb-2">Así se reparte cada peso en un torneo Weekly.</p>
        ...
        <div className="max-w-2xl mx-auto card p-8 mt-10 text-left">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-[13px]">
            ...
            <div className="sm:col-span-2 flex justify-between py-2">
              <span className="flex items-center gap-2 text-ash"><span className="w-2 h-2 rounded-sm bg-[#5f5e5a] shrink-0" />Operación, staff, producción</span>
      ...
      <section className="bg-bg-dark" id="comunidad">
        <div className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center">
          ...
          <p className="text-[15px] text-smoke max-w-md mx-auto leading-relaxed mb-6">
            Buscás dúo, ves el bracket en vivo, recibís los códigos de lobby y te enterás primero. Todo pasa ahí.
          </p>
      ...
      <section className="max-w-7xl mx-auto px-5 md:px-10 py-20 text-center" id="faq">
        ...
        <h2 className="section-title">Lo que te estás<br />preguntando.</h2>
        <FAQ />
      </section>
      ...
      <section className="relative py-24 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-xl mx-auto px-5">
          <div className="section-tag">Próximo torneo · 25 ABR</div>
          <h2 className="section-title !text-[42px] md:!text-[52px]">Los cupos se<br />llenan rápido.</h2>
...
// FAQ as client component inline
function FAQ() {
  return <FAQClient />;
}
